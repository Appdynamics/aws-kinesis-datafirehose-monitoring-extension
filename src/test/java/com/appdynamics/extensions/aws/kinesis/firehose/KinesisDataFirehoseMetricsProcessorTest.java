...
/**
 * Created by pradeep.nair on 8/20/18.
 */
public class KinesisDataFirehoseMetricsProcessorTest {

    private final NamespaceMetricStatistics namespaceMetricStats = new NamespaceMetricStatistics();
    private KinesisDataFirehoseMetricsProcessor kinesisDataFirehoseMetricsProcessor;
    ...
    public void setup() {
        ...
        dimension.setName("DeliveryStreamName");
        dimension.setDisplayName("DeliveryStreamName");
        dimensions.add(dimension);

        kinesisDataFirehoseMetricsProcessor = new KinesisDataFirehoseMetricsProcessor(new ArrayList<>(), dimensions);
    ...
    private void createNamespaceMetricsStatsForTest() {
        ...
        dimension.withName("DeliveryStreamName").withValue("Sample");
        dimensions.add(dimension);
        ...
        metricStatistic.setMetricPrefix("Custom Metrics|AWS Kinesis Data Firehose|");
    ...
    public void createMetricStatsMapForUploadTest() {
        ...
        String expectedMetricName = "Custom Metrics|AWS Kinesis Data Firehose|Appd|us-west-2|DeliveryStreamName|Sample|testMetric";
